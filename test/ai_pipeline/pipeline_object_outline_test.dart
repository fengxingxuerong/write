...
void main() {
  test('大纲 world/protagonist 为对象时流水线照样跑完（不再类型崩溃）', () async {
    ...
    server.listen((HttpRequest req) async {
      ...
      req.response
        ...
        ..add(utf8.encode(jsonEncode(<String, dynamic>{
    ...
    final Directory dir = Directory.systemTemp.createTempSync('pipeline_obj_');
    ...
    expect(task.totalWords, greaterThan(0));
